...
class ModelTrainer:
    """Class for training models with their respective parameters for hyper-paramter tuning via GridSearch.
    """
    ...
    def load_params_and_models(self) -> Dict[str, Any]:
        """Paramters and models for hyper-paramter tuning.
        
        Returns:
            params (Dict[str, Any]): A dictionary of the model name with the respective parameters.
            models (Dict[str, Any]): models with their parameters,
        """
        try:
            params = {
